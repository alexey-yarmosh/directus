...
function getPathesToSync (subdirs: string[]): Map<string, string> {
	const result = new Map<string, string>([
		[
			...
			'/Users/baderfall/Documents/web/jsd/directus/api/extensions'
		],
		[
			'/Users/baderfall/Documents/web/jsd/globalping-dash-directus/src/extensions/lib',
			'/Users/baderfall/Documents/web/jsd/directus/api'
		],
		...subdirs
			.filter(subdir => !subdir.includes('extensions/bytes-value') && !subdir.includes('extensions/lib'))
			.map(subdir => {
				return [subdir, `/Users/baderfall/Documents/web/jsd/directus/api/extensions`] as const
			})
	]);
...
async function syncAll() {
	// This results in "Operation not permitted" on creating symlinks step, so we are creating folders manually.
	// await execAsync(`mkdir -p /Users/baderfall/Documents/web/jsd/directus/api/extensions`)
	// await execAsync(`mkdir -p /Users/baderfall/Documents/web/jsd/directus/api/lib`)
